...
## 솔루션 13: Microsoft Forms + Power Automate 데이터 수집 자동화
```
status: active | verified: 2025-08 | effort: 낮음
license: Microsoft 365 Business Standard 이상
ms_products: ["Forms", "Power Automate", "SharePoint"]
domains: ["인사/HR", "문서/행정", "고객지원", "구매/조달", "프로젝트 관리"]
keywords: ["설문", "신청서", "점검표", "체크리스트", "양식", "폼", "수집", "등록", "survey", "퀴즈"]
compatible_tools: ["Excel", "SharePoint", "Teams", "Outlook"]
must_have(M001): 데이터 수집·설문·신청서·점검표가 자동화 대상이고 MS Forms 기반 입력 흐름 필요
```

---

## 솔루션 14: Microsoft Planner + Power Automate 업무 관리 자동화
```
status: active | verified: 2025-08 | effort: 낮음
license: Microsoft 365 Business Standard 이상
ms_products: ["Planner", "Power Automate", "Teams"]
domains: ["프로젝트 관리", "인사/HR", "문서/행정", "구매/조달"]
keywords: ["작업", "태스크", "task", "일정", "배정", "진행", "완료", "프로젝트", "할일", "to-do", "추적"]
compatible_tools: ["Teams", "Outlook", "SharePoint"]
must_have(M001): 작업 생성·배정·진행 추적·완료 알림 자동화가 핵심 대상
```

---

## 솔루션 15: AI Builder + Power Automate 문서 처리 자동화
```
status: active | verified: 2025-08 | effort: 중간
license: Microsoft 365 Business Standard 이상 + AI Builder credits
ms_products: ["AI Builder", "Power Automate", "SharePoint"]
domains: ["문서/행정", "재무/회계", "구매/조달", "인사/HR"]
keywords: ["ocr", "문서인식", "영수증", "청구서", "계약서", "스캔", "추출", "자동입력", "ai", "비정형"]
compatible_tools: ["SharePoint", "Excel", "Teams", "Outlook"]
must_have(M001): 비정형 문서(영수증·청구서·계약서·양식)에서 데이터 자동 추출 또는 AI 기반 문서 분류 필요
참고: AI Builder credits 소진 시 추가 비용 발생 — 리스크 항목 필수 포함
```
